...
# Exports Azure Retail Prices JSON results to CSV
...
def get_prices(currency_code: str, filter: str = "", max_pages: int = 9999999):
    ...
    Args:
        ...
        filter (str): Optional filter results string.
        max_pages: Only download max_pages of results - only really useful for debugging
        [Examples](https://docs.microsoft.com/en-us/rest/api/cost-management/retail-prices/azure-retail-prices)
    """
    ...
    export_df = pandas.DataFrame.from_records(sku_list)
